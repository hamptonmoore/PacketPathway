...
describe("ARPTable", () => {
  it("Basic functionality", () => {
    ...
    const interface1 = new NetworkInterface(MACAddress.fromString("00:00:00:00:00:01"), [IPAddress.fromCIDR("192.168.0.1/24")]);
    table.Add(interface1.ip[0], { MAC: interface1.mac, Interface: interface1 });

    const interface2 = new NetworkInterface(MACAddress.fromString("00:00:00:00:00:02"), [IPAddress.fromCIDR("1.2.3.4/32")]);
